...
if ( ! class_exists( 'WC_Ali_Settings' ) ) {
	...
	class WC_Ali_Settings {
		...
		public function add_submenu_page() {
			...
			$this->dro_ali_submenu = add_submenu_page(
				'a2w_dashboard',
				esc_html__( 'Shipment-based products for Ali2Woo', 'wc-ali-products-based-shipment' ),
				esc_html__( 'Shipment-based products', 'wc-ali-products-based-shipment' ),
				'manage_options',
				__FILE__,
				array( $this, 'wc_ali_settings_page' )
			);
		}
		...
		public function register_settings_and_fields() {
			...
			add_settings_field(
				'single_product',
				esc_html__( 'Simple products', 'wc-ali-products-based-shipment' ),
				array( $this, 'simple_products' ),
				__FILE__,
				'dro_shipping_section'
			);

			add_settings_field(
				'variable_product',
				esc_html__( 'Variable products', 'wc-ali-products-based-shipment' ),
				array( $this, 'variable_products' ),
				__FILE__,
				'dro_shipping_section'
			);
			add_settings_field(
				'grouped_product',
				esc_html__( 'Grouped products', 'wc-ali-products-based-shipment' ),
				array( $this, 'grouped_products' ),
				__FILE__,
				'dro_shipping_section'
			);
			add_settings_field(
				'external_product',
				esc_html__( 'external products', 'wc-ali-products-based-shipment' ),
				array( $this, 'external_products' ),
				__FILE__,
				'dro_shipping_section'
			);
		}
		...
		public function simple_products() {
			...
			woocommerce_form_field(
				'dro_shipping_options[simple_products]',
				array(
					'type'        => 'text',
					'id'          => 'simple_products',
		...
		public function variable_products() {
			...
			woocommerce_form_field(
				'dro_shipping_options[variable_products]',
				array(
					'type'        => 'text',
		...
		public function grouped_products() {
			...
			woocommerce_form_field(
				'dro_shipping_options[grouped_products]',
				array(
					'type'        => 'text',
					'id'          => 'grouped_products',
					'desc_tip'    => true,
		...
		public function external_products() {
			...
			woocommerce_form_field(
				'dro_shipping_options[external_products]',
				array(
					'type'        => 'text',
